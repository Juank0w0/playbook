...
juank0w0Repo = new Repo('juank0w0\'s repo', 'Juan Carlos', 'en',
    10, 1, 2, 3, 8)

juank0w0Repo.setIssuesOpen = 3
juank0w0Repo.setIssuesClosed = 0
 
console.log("Repository name: " + juank0w0Repo.name)
console.log("Total issues: " + juank0w0Repo.getTotalIssues)
juank0w0Repo.getGeneralInfo
...
issue = new Issue('New issue', 'juank0w0\'s repo', 'Juan Carlos')
